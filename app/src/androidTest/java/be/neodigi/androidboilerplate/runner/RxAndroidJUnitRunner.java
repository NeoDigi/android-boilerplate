package be.neodigi.androidboilerplate.runner;

import android.os.Bundle;
import android.support.test.espresso.Espresso;

import be.neodigi.androidboilerplate.util.RxIdlingExecutionHook;
import be.neodigi.androidboilerplate.util.RxIdlingResource;
